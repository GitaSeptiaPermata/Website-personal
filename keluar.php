        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4"><i class="fa fa-cloud-upload" aria-hidden="true"></i> Barang Keluar</h1>
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <a href="exportkeluar.php" class="btn btn-dark"><i class="fa fa-print" aria-hidden="true"></i> Export Data Keluar</a>
                            <br>
                            <div class="row mt-4">
                                <div class="col">
                                    <form method="post" class="form-inline">
                                        ...
                                        <button type="submit" name="filter_tgl" class="btn btn-secondary ml-3"><i class="fa fa-search"></i> Filter</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header">
                                                        <h4 class="modal-title"><i class="fa fa-wrench"></i> Edit Barang</h4>
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <button type="submit" class="btn btn-secondary" name="updatebarangkeluar"><i class="fa fa-wrench" aria-hidden="true"></i> Update</button>
                                                        </div>
                                                    </form>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <br>
                                                            <br>
                                                            <button type="submit" class="btn btn-secondary" name="hapusbarangkeluar"><i class="fa fa-trash" aria-hidden="true"></i> Delete</button>
                                                        </div>
                                                    </form>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title"><i class="fa fa-cloud-upload" aria-hidden="true"></i> Tambah Barang Keluar</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <br>
                    <button type="submit" class="btn btn-secondary" name="addbarangkeluar"><i class="fa fa-plus-circle" aria-hidden="true"></i> Submit</button>
                </div>
            </form>
